...
function Step({
  ...
  return (
    <div className="relative group border-[0.5px] border-[#C6A85A]/25 p-8 bg-[radial-gradient(circle_at_top,_rgba(198,168,90,0.16)_0%,_transparent_55%),linear-gradient(to_bottom,rgba(31,58,52,0.85),rgba(15,26,23,0.95))] shadow-[0_0_0_1px_rgba(198,168,90,0.06),0_20px_60px_rgba(0,0,0,0.25)] transition-transform duration-300 hover:-translate-y-1 hover:shadow-[0_0_0_1px_rgba(198,168,90,0.16),0_30px_80px_rgba(0,0,0,0.45)]">
      ...
      <h3 className="relative z-10 font-serif text-foreground text-xl font-medium tracking-tighter mb-2">
        {title}
      </h3>
